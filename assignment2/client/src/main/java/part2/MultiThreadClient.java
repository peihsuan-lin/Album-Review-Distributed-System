...
public class MultiThreadClient {
  ...
  public MultiThreadClient(int threadGroupSize, int numThreadGroups, int delay, String url) {
    ...
    this.delay = delay;
//    this.url = "http://ec2-user@" + url + ".us-west-2.compute.amazonaws.com:8080/java-server_war/AlbumStore";
    this.url = "http://alb-9-704437395.us-west-2.elb.amazonaws.com/java-server_war/AlbumStore";
